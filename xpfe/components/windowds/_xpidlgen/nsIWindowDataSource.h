...
class NS_NO_VTABLE nsIWindowDataSource : public nsISupports {
 public: 
  ...
  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IWINDOWDATASOURCE_IID)

  /**
     * for the given resource name, return the window
     */
  /* nsIDOMWindowInternal getWindowForResource (in string inResource); */
  NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIWINDOWDATASOURCE \
  NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIWINDOWDATASOURCE(_to) \
  NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval) { return _to GetWindowForResource(inResource, _retval); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIWINDOWDATASOURCE(_to) \
  NS_IMETHOD GetWindowForResource(const char *inResource, nsIDOMWindowInternal **_retval) { return !_to ? NS_ERROR_NULL_POINTER : _to->GetWindowForResource(inResource, _retval); } 
