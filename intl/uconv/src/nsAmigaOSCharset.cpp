...
nsPlatformCharset::ConvertLocaleToCharsetUsingDeprecatedConfig(nsAString& locale, nsACString& oResult)
{
  ...
  NS_WARNING("nsPlatformCharset::ConvertLocaleToCharsetUsingDeprecatedConfig needs to be ported to AmigaOS");
...
nsPlatformCharset::GetDefaultCharsetForLocale(const nsAString& localeName, nsACString &oResult)
{
  ...
  // 
  NS_WARNING("nsPlatformCharset::GetDefaultCharsetForLocale needs to be ported to AmigaOS");
...
nsPlatformCharset::Init()
{
  ...
  NS_WARNING("nsPlatformCharset::Init needs to be ported to AmigaOS");
...
nsPlatformCharset::VerifyCharset(nsCString &aCharset)
{
  ...
  NS_WARNING("nsPlatformCharset::VerifyCharset needs to be ported to AmigaOS");
