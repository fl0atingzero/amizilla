...
#define NS_IXPIPROGRESSDIALOG_IID_STR "8cdf1192-8709-4428-ab97-c5b6ceecd7e9"

#define NS_IXPIPROGRESSDIALOG_IID \
  {0x8cdf1192, 0x8709, 0x4428, \
    { 0xab, 0x97, 0xc5, 0xb6, 0xce, 0xec, 0xd7, 0xe9 }}
 ...
 * @status UNDER_REVIEW
 */
class NS_NO_VTABLE nsIXPIProgressDialog : public nsISupports {
 public: 

  NS_DEFINE_STATIC_IID_ACCESSOR(NS_IXPIPROGRESSDIALOG_IID)
  ...
  NS_IMETHOD OnStateChange(PRUint32 index, PRInt16 state, PRInt32 value) = 0;
  ...
  NS_IMETHOD OnProgress(PRUint32 index, PRUint32 value, PRUint32 maxValue) = 0;

};

/* Use this macro when declaring classes that implement this interface. */
#define NS_DECL_NSIXPIPROGRESSDIALOG \
  NS_IMETHOD OnStateChange(PRUint32 index, PRInt16 state, PRInt32 value); \
  NS_IMETHOD OnProgress(PRUint32 index, PRUint32 value, PRUint32 maxValue); 

/* Use this macro to declare functions that forward the behavior of this interface to another object. */
#define NS_FORWARD_NSIXPIPROGRESSDIALOG(_to) \
  NS_IMETHOD OnStateChange(PRUint32 index, PRInt16 state, PRInt32 value) { return _to OnStateChange(index, state, value); } \
  NS_IMETHOD OnProgress(PRUint32 index, PRUint32 value, PRUint32 maxValue) { return _to OnProgress(index, value, maxValue); } 

/* Use this macro to declare functions that forward the behavior of this interface to another object in a safe way. */
#define NS_FORWARD_SAFE_NSIXPIPROGRESSDIALOG(_to) \
  NS_IMETHOD OnStateChange(PRUint32 index, PRInt16 state, PRInt32 value) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnStateChange(index, state, value); } \
  NS_IMETHOD OnProgress(PRUint32 index, PRUint32 value, PRUint32 maxValue) { return !_to ? NS_ERROR_NULL_POINTER : _to->OnProgress(index, value, maxValue); } 
...
/* void onProgress (in unsigned long index, in unsigned long value, in unsigned long maxValue); */
NS_IMETHODIMP nsXPIProgressDialog::OnProgress(PRUint32 index, PRUint32 value, PRUint32 maxValue)
{
    return NS_ERROR_NOT_IMPLEMENTED;
}
