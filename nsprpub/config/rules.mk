...
ifdef MKSHLIB
IMPORT_LIBRARY_X = $(OBJDIR)/$(LIBRARY_NAME)$(LIBRARY_VERSION).x 
IMPORT_LIBRARY_A = $(OBJDIR)/lib$(LIBRARY_NAME)$(LIBRARY_VERSION)_ixlibrary.a
IMPORT_LIBRARY_H = $(OBJDIR)/$(LIBRARY_NAME)$(LIBRARY_VERSION)_ixlibrary.h
endif
endif
...
ifeq ($(OS_ARCH), AmigaOS)
TARGETS		= $(LIBRARY) $(SHARED_LIBRARY) $(IMPORT_LIBRARY_X) $(IMPORT_LIBRARY_A)
else
